            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="home.php"><i class="fa fa-dashboard"></i>Volver al menú
                            </a>
                        </li>
                </div>
            </nav>
                ...
                <div id="page-inner">
                    ...
                    if (isset($_POST['up'])) {
                        ...
                        if (mysqli_query($con, $upsql)) {
                            echo' <script language="javascript" type="text/javascript">  Alert.render("User name and password update") </script>';
                        }
