                                ...
                                <div class="panel-body">
                                    <div class="panel-group" id="accordion">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    while ($trow = mysqli_fetch_array($tre)) {
                                                                        ...
                                                                        if ($co == "No Confirmado") {
                                                                            echo"<tr>
                                                                            <th style='text-align:center'>" . $trow['id'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['FName'] . " " . $trow['LName'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['Email'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['Country'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['TRoom'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['NRoom'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['Meal'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['cin'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['cout'] . "</th>
                                                                            <th style='text-align:center'>" . $trow['stat'] . "</th>
                                        ...
                                        ?>
                                                            ...
                                                            <a href="messages.php" class="btn btn-primary">Gestionar contactos
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
