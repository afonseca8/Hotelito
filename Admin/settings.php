                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="settings.php"><i class="fa fa-gear fa-fw"></i> Manejo de Habitaciones</a>
                            </li>
                            <li class="divider"></li>
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Detalle de habitaciones
                            </a>
                        </li>
                        <li>
                            <a  href="room.php"><i class="fa fa-plus-circle"></i>Agregar/Eliminar habitación</a>
                        </li>
                </div>
            </nav>
            <!-- /. NAV SIDE  -->
