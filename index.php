...
<html lang="en">
    ...
    <body>
        ...
        <div class="banner-top">
            <div class="social-bnr-agileits">
                <ul class="social-icons3">
                    ...
                    <li><a href="https://www.youtube.com/watch?v=6LyuAXrpN9U" class="fa fa-youtube icon-border youtube" > </a></li> 
                </ul>
            </div>
            <div class="contact-bnr-w3-agile">
                <ul>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:hotelparadors@gmail.com">hotelparadors@gmail.com</a></li>
                    <li><i class="fa fa-phone" aria-hidden="true"></i>+(506) 8767-6064</li>	
                    <li class="s-bar">
                        <div class="search">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class="menu__item"><a href="admin/index.php">Admin</a></li>
                            </ul>
                        </nav>
                    </div>
                </nav>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4>HOTEL
                            <span>PARADOR</span></h4>
                        <img src="images/1.jpg" alt=" " class="img-responsive">
                        <h5>Sabemos lo que amas</h5>
                        <p>Ofrecer a los huéspedes vistas únicas y encantadoras desde sus habitaciones con sus comodidades excepcionales,<br> hace que Parador Resort sea uno de los mejores en su tipo. <br>Pruebe nuestro menú de comida, servicios increíbles y un personal amable mientras esté aquí.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="cbp-ig-grid">
                        <li>
                            <div class="w3_grid_effect">
                                ...
                                <span class="cbp-ig-category">VIELHA SUITS</span>
                            </div>
                        </li>
                        <li>
                            <div class="w3_grid_effect">
                                <span class="cbp-ig-icon w3_cube"></span>
                                <h4 class="cbp-ig-title">EN PARADOR CONTAMOS</h4>
                                <span class="cbp-ig-category">VALCONES VISTA AL MAR</span>
                            </div>
                        </li>
                        <li>
                            <div class="w3_grid_effect">
                                <span class="cbp-ig-icon w3_users"></span>
                                <h4 class="cbp-ig-title">RESTAURANTES ESTRELLA  
                                </h4>
                                <span class="cbp-ig-category">ALCALÁ</span>
                            </div>
                        </li>
                        <li>
                            <div class="w3_grid_effect">
                                <span class="cbp-ig-icon w3_ticket"></span>
                                <h4 class="cbp-ig-title">PARADOR OFRECE EL</h4>
                                <span class="cbp-ig-category">WIFI EN TODO LUGAR
                                </span>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="about-wthree" id="about">
            <div class="container">
                <div class="ab-w3l-spa">
                    <h3 class="title-w3-agileits title-black-wthree">Acerca de nuestro PARADOR
                    </h3> 
                    <p class="about-para-w3ls"> “Por muy larga que sea la tormenta, el sol siempre vuelve a brillar entre las nubes.” Equipo.PARADOR
                    </p>
        ...
        <div class="team" id="team">
            <div class="container">
                <h3 class="title-w3-agileits title-black-wthree">Conoce al equipo</h3>
                    ...
                    <div class="resp-tabs-container">
                        <div class="tab1">
                            ...
                            <div class="col-md-6 team-Info-agileits">
                                ...
                                <p>"Porque siempre pensamos primero en nuestros clientes, mezclamos comodidad con un precio económico para que disfrute de sus mejores vacaciones."</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                        <div class="tab2">
                            ...
                            <div class="col-md-6 team-Info-agileits">
                                <h4>Sara Jiménez</h4>
                                <span>Encargada de personal
                                </span>
                                <p>"Estamos para hacer de tus vaciones las mejores.Te ofrecemos la experiencia más completa."</p>	
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                        <div class="tab3">
                            ...
                            <div class="col-md-6 team-Info-agileits">
                                <h4>Ivan Morales</h4>
                                <span>Manager</span>
                                <p>"¿Qué esperas para disfrutar los momentos más inolvidables de tu vida?"</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                    </div>
        ...
        <div class="w3l-visitors-agile" >
            <div class="container">
                <h3 class="title-w3-agileits title-black-wthree">Qué experimentaron otros visitantes!! 
                </h3> 
            </div>
                        ...
                        <ul class="slides">
                            <li>
                                ...
                                <div class="w3layouts_work_grid_right">
                                    ...
                                    <p>Es fascinantes y divertido pase momentos agradables. </p>
                                    <h5>Marie Hill</h5>
                                    <p>Suiza</p>
                                </div>
                                <div class="clearfix"> </div>
                            ...
                            <li>
                                ...
                                <div class="w3layouts_work_grid_right">
                                    ...
                                    <p>La pasamos genial en familia</p>
                                    <h5>Jhonatan Smith</h5>
                                    <p>Estados Unidos
                                    </p>
                                </div>
                                <div class="clearfix"> </div>
                            ...
                            <li>
                                ...
                                <div class="w3layouts_work_grid_right">
                                    ...
                                    <p>Es fascinante y divertido. </p>
                                    <h5>Rosalyn Clober</h5>
                                    <p>Polonia</p>
                                </div>
                                <div class="clearfix"> </div>
                            </li>
        ...
        <section class="contact-w3ls" id="contact">
            <div class="container">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
                    ...
                    <p class="contact-agile1"><strong>Teléfono :</strong>+(506) 8767-6064</p>
                    <p class="contact-agile1"><strong>Email :</strong> <a href="mailto:hotelparadors@gmail.com">hotelparadors@gmail.com</a></p>
                    <p class="contact-agile1"><strong>Direccion :</strong> Puntarenas,Costa Rica</p>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3936.2757391193422!2d-84.17072763498429!3d9.397181185700461!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa173a9a304830f%3A0x1ab4375a2dbb8ca1!2sParador+Resort+%26+Spa+Manuel+Antonio!5e0!3m2!1ses!2scr!4v1527241662616" ></iframe>
                </div>
                <div class="clearfix"></div>
            </div>
        </section>
        <!-- /contact -->
        <div class="copy">
            <p>© 2018  <a href="index.php">HOTEL PARADOR</a> </p>
        </div>
        <!--/footer -->
        <!-- js -->
